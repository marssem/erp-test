...
public class EmployeeDAOImpl implements EmployeeDAO {
	...
	public int updateEmployee(Map<String, Object> emp) {
		 ...
		 try {
			 ...
			 ps.setObject(4, emp.get("emp_active"));
	...
	public int insertEmployee(Map<String, Object> emp) {
		 ...
		 try {
			 con = Conn.open();
			 String sql = "insert into employee(emp_no, emp_name, emp_salary, grd_no, emp_active, emp_credat) "
			 		+ "values((select max(emp_no)+1 from employee), ?, ?, ?, ?, sysdate)";
			 ps = con.prepareStatement(sql);
			 ps.setObject(1, emp.get("emp_name"));
			 ps.setObject(2, emp.get("emp_salary"));
			 ps.setObject(3, emp.get("grd_no"));
	...
	public List<Map<String, Object>> selectEmployeeList(Map<String, Object> emp) {
		...
		Connection con = null;
		 ...
		 try {
			...
			sql += "select g.grd_name from employee e, grade g\r\n" + 
...
public static void main(String[] args) {
	...
	map.put("emp_no", 202);
	System.out.println(emp.selectEmployeeList(map));
}
}
